import 'package:cartech_mechanic_app/src/blocs/sign_up_bloc.dart';
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                _textField(
                    "Correo electronico", false, signUpBloc.emailController),
                SizedBox(
                  height: 20,
                ),
                _textField("Numero de telefono", false,
                    signUpBloc.phoneNumberController),
                SizedBox(
                  height: 20,
                ),
